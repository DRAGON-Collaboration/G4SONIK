...
class CrossSectionManager {
 ...
 ~CrossSectionManager();
  ...
  double theta, phi, thetacm/*rad*/, E_scat/*MeV*/, E_scatcm, n_scat/*total number of scattering events*/;
  double theta_beam/*rad*/, E_beam/*MeV*/, n_beam/*total number of scattering events*/; /////////////////////////////
