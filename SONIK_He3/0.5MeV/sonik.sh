...
declare -a col=("1")
declare -a deg=("22.5" "35" "40" "45" "55" "60" "65" "75" "90" "120")

declare -a SNtm=("17" "30" "35" "40" "39" "36" "32" "26" "18" "8") #Ejectile + Recoil for He3->He4 at 0.5MeV
declare -a SNtM=("74" "64" "60" "55" "60" "65" "70" "80" "24" "11") 
...
for i in "${col[@]}";do
	...
	for j in "${deg[@]}";do
		...
		mkdir "$j"deg
  		cp "/local/astro/scat/SONIK_He3/0.5MeV/3He(a,a)_abinitio.dat" "$j""deg/3He(a,a)_abinitio.dat"
