...
void rootscript2()
{
	...
	for (int p=0;p<5;p++)
	{
		for (int q=0;q<11;q++)
		{
			...
			if (p == 0) {str = "/local/astro/scat/SONIK_He3/1.5MeV/1mm_10k_pnA/";}
			if (p == 1) {str = "/local/astro/scat/SONIK_He3/1.5MeV/2mm_10k_pnA/";}
			
			if (p == 2) {str = "/local/astro/scat/SONIK_He3/1.5MeV/3mm_10k_pnA/";}
			if (p == 3) {str = "/local/astro/scat/SONIK_He3/1.5MeV/5mm_10k_pnA/";}
			if (p == 4) {str = "/local/astro/scat/SONIK_He3/1.5MeV/7mm_10k_pnA/";}
